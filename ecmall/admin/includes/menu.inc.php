    ...
    'trade' => array(
        ...
        'children'  => array(
            'order_manage' => array(
             ...
             'pay' => array(
                'text'  => Lang::get('pay'),
                'url'   => 'index.php?app=pay'
            ),
             'funds' => array(
                'text'  => Lang::get('funds'),
                'url'   => 'index.php?app=funds'
            ),
            )
        ),
	//拍卖
	'auction' => array(
		'text' 		=> Lang::get('auction'),
		'default' 	=> 'auction_manage',
		'children' 	=> array(
			'auction_manage' => array(
				'text' 	=> Lang::get('auction_manage'),
				'url'	=> 'index.php?app=auction'
			),
			'p_auction_manage' => array(
				'text' => Lang::get('p_auction_manage'),
				'url' => 'index.php?app=auction&act=personal',
			),
			/*
			'auction_back_money' => array(
				'text' => Lang::get('auction_back_money'),
				'url' => 'index.php?app=auction&act=back_money'
			),
			*/
			'market_auction_manage' => array(
				'text' => Lang::get('market_auction_manage'),
				'url' => 'index.php?app=auction&act=market'
			),
		),
	),
    // 网站
