...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1386591112, '1', './data/template/1_1_common_header_member_clearcookies.tpl.php', './template/default', 'common/header_member_clearcookies')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1386591112, '1', './data/template/1_1_common_header_member_clearcookies.tpl.php', './template/default', 'common/header_member_clearcookies')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1386591112, '1', './data/template/1_1_common_header_member_clearcookies.tpl.php', './template/default', 'common/header_member_clearcookies')
;?>
