    ...
    function get_default()
    {
        return array(
            ...
            'touser_send_coupon'=> array(
             ...
             'tomember_member_closed_notify'=> array(
                'description' => Lang::get('tomember_member_closed_notify_desc'),
            ),
             'tomember_store_opened_notify'=> array(
                'description' => Lang::get('tomember_store_opened_notify_desc'),
            ),
             'tomember_member_passed_notify'=> array(
                'description' => Lang::get('tomember_member_passed_notify_desc'),
            ),
             'tomember_member_refused_notify'=> array(
                'description' => Lang::get('tomember_member_refused_notify_desc'),
            ),
