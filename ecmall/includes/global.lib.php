...
function &ms()
{
    ...
    if ($ms === null)
    {
        include_once(ROOT_PATH . '/includes/passport.base.php');
...
function funds_in_out($lang_key)
{
...
function pay_status($pay_status)
{
    ...
    switch ($pay_status)
    {
        ...
        case PAY_ACCEPTED:
        case ORDER_SHIPPED:
            $lang_key = 'pay_accepted';
        break;
        case PAY_FINISHED:
            $lang_key = 'pay_finished';
        break;
        case PAY_CANCELED:
            $lang_key = 'pay_canceled';
        break;
    }
    return $lang_key  ? Lang::get($lang_key) : $lang_key;
}
...
function pay_type($pay_type)
{
    ...
    {
        case PAY_TYPE_GOOD:
            $lang_key = 'pay_type_good';
        break;
        case PAY_TYPE_CAUTION:
            $lang_key = 'pay_type_caution';
        break;
        case PAY_TYPE_TAX:
            $lang_key = 'pay_type_iax';
        break;
...
function funds_type($pay_type)
{
    ...
    switch ($pay_type)
    {
        ...
        break;
        case FUNDS_ALPAY:
            $lang_key = 'funds_alpay';
        break;
        case FUNDS_WANYIN:
            $lang_key = 'funds_wangyin';
        break;
        case FUNDS_PLAT:
            $lang_key = 'funds_plat';
        break;
