...
class RecommendModel extends BaseModel
{
    ...
    function get_recommended_goods($recom_id, $num, $default_image = true, $mall_cate_id = 0)
    {
        ...
        {
            /* 推荐商品 */
            $sql = "SELECT g.goods_id, g.goods_name, g.default_image, gs.price, gs.stock, s.owner_name " .
    ...
    {
        $sql = "SELECT * FROM " . DB_PREFIX . "recommend  " .
                    "WHERE store_id = 0 order by recom_id asc LIMIT 1";
