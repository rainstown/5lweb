...
return array(
    ...
    'check_code'    => '手机验证码',
    'check_code_required'    => '验证码必填',
    'check_code_funds_out' => '<input class="btn1" type="button" ectype="dialog" uri="index.php?app=checkmobcode&act=get_check_code&type=1&ajax" dialog_title="获取验证码" dialog_width="400" value="获取验证码"/>',
    'check_code_bank_info' => '<input class="btn1" type="button" ectype="dialog" uri="index.php?app=checkmobcode&act=get_check_code&type=2&ajax" dialog_title="获取验证码" dialog_width="400" value="获取验证码"/>',
    'check_code_pay_pws' => '<input class="btn1" type="button" ectype="dialog" uri="index.php?app=checkmobcode&act=get_check_code&type=3&ajax" dialog_title="获取验证码" dialog_width="400" value="获取验证码"/>',
    
    'check_code_desc' => '<input class="btn1" type="button" onclick="javascript:get_check_code()" dialog_title="获取验证码" dialog_width="400" value="获取验证码"/>',
    'check_code_error' => '手机验证码错误',
    'phone_mob_desc' => ' 用户接收验证码',
    'phone_mob_required' => '手机号码必填',
    'phone_mob_error' => '手机格式错误',
    
    'check_reg_mob_code_error' => '请确认注册手机号和接收验证码的手机号是否一致',
		
		
	//拍卖会公用
	'auction_type_market' => '集市拍卖',
	'auction_type_personal' => '个人拍卖',
	'auction_type_offical'	=>	'专场拍卖',
	//状态
	'status_valid' => '启用',
	'status_invalid' => '停用',
	'status_close'	=> '关闭',
	'status_not_approve' => '待审核',
	'status_pass'	=> '审核通过',
	'status_deny'	=>	'审核不通过',
	
	'auction' => '拍卖',
	'form_required_true' => '必填',
	'form_digits_true' => '必须为整数',
	'form_date_true' => '日期格式不正确，应该为yy-mm-dd',
	'form_min_1' => '必须大于或等于1',
	'form_min_100' => '必须小于或等于100',
	'form_select_true' => '请选择',
    ...
    'sms_check_time_limit' => '发送时间至少间隔60秒。',
    'sms_check_code_success' => '手机验证码发送成功，请查收。',
    'sms_check_code_fail' => '手机验证码发送失败。',
