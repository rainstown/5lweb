...
<div class="info">
  <form method="post" enctype="multipart/form-data" id="store_form">
    <table class="infoTable">
      ...
      <?php endif; ?>
      <tr>
        <th class="paddingT15">序号:</th>
        <td class="paddingT15 wordSpacing5"><input class="infoTableInput2" name="store_order" type="text" id="order_id" value="<?php echo $this->_var['store']['store_order']; ?>" /></td>
      </tr>
      <tr>
