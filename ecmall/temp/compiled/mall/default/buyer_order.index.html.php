...
?>
                <div class="order_form">
                    <h2>
                        <p class="num">订单号: <?php echo $this->_var['order']['order_sn']; ?><?php if ($this->_var['order']['extension'] == 'groupbuy'): ?><span class="color8">[团购]</span><?php elseif ($this->_var['order']['extension'] == 'auction'): ?><span class="color8">[拍卖]</span><?php endif; ?></p>
...
?>
                    ...
                    <div class="foot">
                        ...
                        <div class="handle">
                            ...
                            <input type="button" value="取消订单" class="btn1" ectype="dialog" dialog_width="400" dialog_title="取消订单" dialog_id="buyer_order_cancel_order" uri="index.php?app=buyer_order&amp;act=cancel_order&order_id=<?php echo $this->_var['order']['order_id']; ?>&ajax"  id="order<?php echo $this->_var['order']['order_id']; ?>_action_cancel"<?php if (( $this->_var['order']['status'] != ORDER_PENDING && $this->_var['order']['status'] != ORDER_SUBMITTED ) || $this->_var['order']['extension'] == 'auction'): ?> style="display:none"<?php endif; ?> />
