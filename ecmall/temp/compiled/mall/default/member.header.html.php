...
<div>
<div id="header">
    <h1 title="<?php echo $this->_var['site_title']; ?>" style="top:7px"><a href="index.php"><img src="http://scp.weilearn.com/data/files/mall/settings/site_logo_1.jpg" alt="<?php echo $this->_var['site_title']; ?>" width="120" /></a></h1>
    <div id="subnav">
        <p>
    ...
    <div id="topbtn">
        ...
        <span id="child_nav">
            <a class="link user" href="<?php echo url('app=member'); ?>" style="margin-left:10px; background-position: 50px -105px;">用户中心</a>
            <ul id="float_layer">
                <div id="adorn1"></div>
                <div id="adorn2"></div>
        ...
        <span style="padding:0px 10px; float:left">|</span>
