            ...
            <div class="public">
                <div class="information_index">
                    ...
                    <div class="info">
                        ...
                        <?php else: ?>
                        <p style="color: red">您未申请实名认证，请先申请<a href="index.php?app=member_auth">实名认证</a></p>
                        <?php endif; ?>
                        <?php if ($this->_var['bank_info']['bank_id'] > 0): ?>
                        <p>账户余额：<?php echo $this->_var['bank_info']['money']; ?></p>
                        <?php else: ?>
                        <p style="color: red">您还未开通三多九如支付账户，请点击<a href="<?php echo url('app=account'); ?>">申请开通</a>。</p>
                        <?php endif; ?>
                    </div>
                </div>
