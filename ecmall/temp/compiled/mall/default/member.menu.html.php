...
?>
        ...
        <?php endif; ?>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    <?php if ($this->_var['_member_menu']['member_auth']): ?>
        <dl>
            <dt><?php echo $this->_var['_member_menu']['member_auth']['text']; ?></dt>
            <dd><a href="<?php echo $this->_var['_member_menu']['member_auth']['url']; ?>" class="normal" title="<?php echo $this->_var['_member_menu']['member_auth']['text']; ?>"> 
                <span  ><?php echo $this->_var['_member_menu']['member_auth']['text']; ?></span>
                </a><dd>
        </dl>
        <div class="clear"></div> 
        <div class="application">
            <p>您目前不是卖家，您可以: </p>
            <a href="<?php echo $this->_var['_member_menu']['member_auth']['url']; ?>" title="<?php echo $this->_var['_member_menu']['overview']['text']; ?>"></a>
        </div>
        <?php endif; ?>
