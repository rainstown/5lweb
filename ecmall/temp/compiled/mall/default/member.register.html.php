                ...
                <div class="login_con">
                    <div class="login_fill_in">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>手 机:</td>
                                <td><input type="text" id="phone_mob" name="phone_mob" class="text width10" /></td>
                                <td class="padding3 fontColor4"><label class="field_notice"> 用户接收验证码</label></td>
                            </tr>
                            <tr>
                                <td>手机验证码:</td>
                                <td><input type="text" name="check_code" class="text width10" /></td>
                                <td class="padding3 fontColor4"><input class="btn1" type="button" onclick="javascript:get_check_code()" dialog_title="获取验证码" dialog_width="400" value="获取验证码"/> <label class="field_notice"></label></td>
                            </tr>
...
function get_check_code(){
   ...
   var url = 'index.php?app=checkmobcode&act=get_register_code&mob='+ $('#phone_mob').val()+'&key=<?php echo $this->_var['key']; ?>';
