                ...
                <table class="table_head_line">
                    ...
                    <?php if ($_GET['act'] != 'announcepm'): ?>
                        ...
                        <th class="align1" colspan="4">
                            ...
                            <a href="javascript:;" class="delete" uri="index.php?app=message&act=drop_chat" name="msg_id" presubmit="confirm('您确定要删除它吗？')" ectype="batchbutton">删除</a>
                        </th>
                    <?php else: ?>
                        <th class="width1"></th>
                        <th colspan="5"></th>
...
?>
                    <tr <?php if (($this->_foreach['v']['iteration'] == $this->_foreach['v']['total'])): ?>class="line_bold"<?php else: ?>class="line"<?php endif; ?>>
                        <td class="align2"><?php if ($_GET['act'] != 'announcepm'): ?><input type="checkbox" class="checkitem" value="<?php echo $this->_var['message']['msg_id']; ?>_<?php echo $this->_var['message']['from_id']; ?>"/><?php endif; ?></td>
                        ...
                        <td class="width8">
                            <a href="<?php echo url('app=message&act=view&msg_id=' . $this->_var['message']['msg_id']. ''); ?>&from_id=<?php echo $this->_var['message']['from_id']; ?>" class="desc">查看详情</a>
                            <?php if ($_GET['act'] != 'announcepm'): ?><a href="javascript:drop_confirm('您确定要删除它吗？', 'index.php?app=message&amp;act=drop_chat&msg_id=<?php echo $this->_var['message']['msg_id']; ?>_<?php echo $this->_var['message']['from_id']; ?>');" class="delete">删除</a><?php endif; ?>
                        </td>
                    </tr>
                    <?php endforeach; else: ?>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th class="align1"><label for="all2"><span class="all">全选</span></label><a href="javascript:void(0);" class="delete" uri="index.php?app=message&act=drop_chat" name="msg_id" presubmit="confirm('您确定要删除它吗？')" ectype="batchbutton">删除</a></th>
                        <td colspan="3">
                           <p class="position2">
