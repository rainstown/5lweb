        ...
        <div class="wrap">
            <div class="public">
                <div class="message message_line">
                    ...
                    <h2>
                        <span>&nbsp;</span>
                        <a class="delete" href="javascript:drop_confirm('您确定要删除它吗？', 'index.php?app=message&amp;act=drop_relate&amp;back=<?php echo $this->_var['box']; ?>&amp;msg_id=<?php echo $this->_var['message']['msg_id']; ?>&amp;from_id=<?php echo $this->_var['message']['from_id']; ?>');">删除</a>    
                    </h2>
                    <?php else: ?>
                    ...
                    <dl>
                        ...
                        <dd>
                            ...
                            <div id="short_msg_desc" style="margin-left:0px; margin-bottom:10px;"><a href="javascript:;" id="msg_instrunction">短消息使用格式?</a>
                                <div>字体加粗：[b]加粗[/b]<br />图片标签：[img]http://ecmall.shopex.cn/images/logo.gif[/img]<br/>超链接标签：[url=http://ecmall.shopex.cn]ECMall官方网站[/url]<br/>引用标签：[quote]ECMall[/quote]<br />代码标签：[code]array('2222','3333')[/code]</div>
                            </div>
