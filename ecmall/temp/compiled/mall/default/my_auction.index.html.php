...
<div class="content">
	...
	<div id="right">
		...
		<div class="wrap">
			<div class="eject_btn_two eject_pos1" title="新增个人拍卖会">
				<b class="ico1" ectype="dialog" dialog_title="新增个人拍卖会" dialog_id="my_auction_edit" dialog_width="600" uri="index.php?app=my_auction&act=edit">新增个人拍卖会</b>
			</div>
			<div class="public_select table">
				<table id="my_auction" server="<?php echo $this->_var['site_url']; ?>/index.php?app=my_auction&amp;act=ajax_col">
							...
							<div class="select_div">
								<form id="my_auction_form" method="get">
									...
									<a class="detlink" style="float: right"
										href="<?php echo url('app=my_auction'); ?>">取消检索</a>
									<?php endif; ?>
					...
					<tr class="gray" ectype="table_header">
						...
						<th width="25" column="status"
							title="排序" class="cursor_pointer"><span
							ectype="order_by">状态</span></th>
...
?>
					<tr
						...
						<td width="" class="align2">
							<?php if ($this->_var['auction']['can_edit']): ?>
							<a href="javascript:void(0);" ectype="dialog" dialog_id="my_auction_edit" dialog_title="编辑个人拍卖" dialog_width="600" uri="index.php?app=my_auction&act=edit&id=<?php echo $this->_var['auction']['auction_id']; ?>" class="edit1 float_none">编辑</a>
							<?php endif; ?>
