                ...
                <div class="make_sure">
                    <p>订单总价:&nbsp;<strong class="fontsize3" id="order_amount"><?php echo price_format($this->_var['goods_info']['amount']); ?></strong>
                        <!-- 
                        <?php if ($this->_var['goods_info']['allow_coupon']): ?>&nbsp;&nbsp;<input type="button" class="btn1" onclick="$(this).parent('p').next().toggle();$('#coupon_sn').val('');" /><?php endif; ?></p>
