...
?>
                    <tr class="color2">
                        <td class="align2"><input type="checkbox" value="<?php echo $this->_var['order']['order_id']; ?>" class="checkitem" <?php if ($this->_var['order']['status'] == ORDER_FINISHED || $this->_var['order']['status'] == ORDER_CANCELED || $this->_var['order']['extension'] == 'auction'): ?> disabled="disabled" <?php endif; ?>/></td>
                        <td><span class="color3"><?php echo $this->_var['order']['order_sn']; ?><?php if ($this->_var['order']['extension'] == 'groupbuy'): ?><span class="color8">[团购]</span><?php elseif ($this->_var['order']['extension'] == 'auction'): ?><span class="color8">[拍卖]</span><?php endif; ?></span></td>
                    ...
                    <tr class="line_bottom">
                        ...
                        <?php if ($this->_var['order']['extension'] != 'auction'): ?>
